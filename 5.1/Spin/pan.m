...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 7: // STATE 20 - _spin_nvr.tmp:15 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC entorno */
	case 8: // STATE 1 - ej5.pml:27 - [bit0 = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[1][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 9: // STATE 2 - ej5.pml:28 - [(!(bit0))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][2] = 1;
		if (!( !(((int)now.bit0))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 10: // STATE 4 - ej5.pml:29 - [bit15 = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[1][4] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 11: // STATE 5 - ej5.pml:30 - [(!(bit15))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][5] = 1;
		if (!( !(((int)now.bit15))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 12: // STATE 10 - ej5.pml:32 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[1][10] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC lampara */
	case 13: // STATE 1 - ej5.pml:8 - [state = OFF] (0:0:1 - 1)
		IfNotBlocked
		reached[0][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 14: // STATE 2 - ej5.pml:10 - [((state==OFF))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][2] = 1;
		if (!((((int)now.state)==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 15: // STATE 3 - ej5.pml:12 - [(bit0)] (22:0:2 - 1)
		IfNotBlocked
		reached[0][3] = 1;
		if (!(((int)now.bit0)))
			continue;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 16: // STATE 10 - ej5.pml:15 - [.(goto)] (0:22:0 - 2)
		IfNotBlocked
		reached[0][10] = 1;
		;
		/* merge: .(goto)(0, 23, 22) */
		...
		;
		_m = 3; goto P999; /* 1 */
	case 17: // STATE 6 - ej5.pml:13 - [(bit15)] (22:0:2 - 1)
		IfNotBlocked
		reached[0][6] = 1;
		if (!(((int)now.bit15)))
			continue;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 18: // STATE 12 - ej5.pml:16 - [((state==ON))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][12] = 1;
		if (!((((int)now.state)==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 19: // STATE 13 - ej5.pml:18 - [(bit0)] (22:0:2 - 1)
		IfNotBlocked
		reached[0][13] = 1;
		if (!(((int)now.bit0)))
			continue;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 20: // STATE 20 - ej5.pml:21 - [.(goto)] (0:22:0 - 2)
		IfNotBlocked
		reached[0][20] = 1;
		;
		/* merge: .(goto)(0, 23, 22) */
		...
		;
		_m = 3; goto P999; /* 1 */
	case 21: // STATE 16 - ej5.pml:19 - [(bit15)] (22:0:2 - 1)
		IfNotBlocked
		reached[0][16] = 1;
		if (!(((int)now.bit15)))
			continue;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 22: // STATE 25 - ej5.pml:23 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][25] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
