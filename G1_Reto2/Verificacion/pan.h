...
#define PanSource	"fsm_verif.pml"
...
#define Pfsm_pelota	((P2 *)this)
typedef struct P2 { /* fsm_pelota */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Pfsm_raqueta	((P1 *)this)
typedef struct P1 { /* fsm_raqueta */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Pfsm_pantalla	((P0 *)this)
typedef struct P0 { /* fsm_pantalla */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
