/*** Generated by Spin Version 6.4.7 -- 19 August 2017 ***/
/*** From source: ej7.pml ***/
...
short src_ln1 [] = {
	  0,  68,  69,  69,  70,  71,  71,  72, 
	 73,  73,  74,  75,  75,  67,  77,  67, 
	 77,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "ej7.pml", 1, 16 },
...
short src_ln0 [] = {
	  0,   8,  10,  12,  12,  12,  11,  14, 
	 10,  15,  17,  17,  17,  18,  18,  18, 
	 19,  19,  19,  16,  21,  15,  22,  24, 
	 24,  24,  25,  25,  25,  26,  26,  26, 
	 23,  28,  22,  29,  31,  31,  31,  32, 
	 32,  32,  33,  33,  33,  30,  35,  29, 
	 36,  38,  38,  38,  39,  39,  39,  40, 
	 40,  40,  37,  42,  36,  43,  45,  45, 
	 45,  46,  46,  46,  47,  47,  47,  44, 
	 49,  43,  50,  52,  52,  52,  53,  53, 
	 53,  54,  54,  54,  51,  56,  50,  57, 
	 59,  59,  59,  60,  60,  60,  58,  62, 
	 57,   9,  64,   9,  64,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "ej7.pml", 1, 100 },
...
iniglobals(int calling_pid)
{
		...
		logval("p0", now.p0);
		logval("p15", now.p15);
		logval("time2s", now.time2s);
		logval("time10s", now.time10s);
...
{	/* int i; */
	...
	printf("	bit    p15:	%d\n", now.p15);
	printf("	bit    time2s:	%d\n", now.time2s);
	printf("	bit    time10s:	%d\n", now.time10s);
	printf("	mtype  ALARM_OFF:	8\n");
	printf("	mtype  ALARM_ON:	7\n");
	printf("	mtype  EN_FIGURE_1:	6\n");
	printf("	mtype  EN_FIGURE_2:	5\n");
	printf("	mtype  EN_FIGURE_3:	4\n");
	printf("	mtype  DIS_FIGURE_1:	3\n");
	printf("	mtype  DIS_FIGURE_2:	2\n");
	printf("	mtype  DIS_FIGURE_3:	1\n");
	printf("	byte   state:	%d\n", now.state);
}
void
...
{
	switch (x) {
	case 1: Printf("DIS_FIGURE_3"); break;
	case 2: Printf("DIS_FIGURE_2"); break;
	case 3: Printf("DIS_FIGURE_1"); break;
	case 4: Printf("EN_FIGURE_3"); break;
	case 5: Printf("EN_FIGURE_2"); break;
	case 6: Printf("EN_FIGURE_1"); break;
	case 7: Printf("ALARM_ON"); break;
	case 8: Printf("ALARM_OFF"); break;
	default: Printf("%d", x);
	}
}
void
