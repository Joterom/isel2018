...
#define _nstates2	21	/* spec */
#define minseq2	35
#define maxseq2	54
#define _endstate2	20

#define _nstates1	11	/* entorno */
#define minseq1	25
#define maxseq1	34
#define _endstate1	10

#define _nstates0	26	/* lampara */
#define minseq0	0
#define maxseq0	24
...
#define Plampara	((P0 *)this)
typedef struct P0 { /* lampara */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
